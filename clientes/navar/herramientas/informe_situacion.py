...
def armar(D, out):
    ...
    S += [PageBreak(), P("1 · De dónde salen los números", "h1"),
          ...
          LI("<b>Deuda impositiva</b>: la planilla de vencimientos de administración, revisada por el estudio contable el 18/09."),
          LI("<b>Respuestas de administración</b> (18/09) sobre lo que los extractos no explican solos: venta de valores, tarjeta AgroNación, cheques, sueldos, la caja de AA."),
          ...
          LI("La <b>cosecha</b> (abril a septiembre) ya pasó este año y no vuelve como tal: para 2027 NAVAR planea comprar canchada y vender molida, sin cosecha ni secanza propias (administración, 21/09). Ese costo entra como compra a proveedores; la proyección no tiene un renglón de cosecha."),
    ...
    S += [PageBreak(), P("6 · Prioridades de pago: por consecuencia, no por antigüedad", "h1"),
          P("La prioridad no es «a quién le debemos más» sino «qué pasa si no pagamos». Es la que está cargada en la columna Prioridad de la solapa Plan y se ajusta con administración.", "p"),
    ...
    S += [P("Esta semana: que no se corte nada vital", "h3"),
          ...
          tabla([["Qué", "Quién", "Cuándo"],
                 ["Confirmar el orden de prioridades y las decisiones de la solapa Plan", "administración + finauto", "esta semana"],
                 ["Pagar lo urgente de ARCA y generar los VEP", "administración / la dirección", "antes del 25/09"],
                 ["Pedir al estudio el plan más largo posible para SICORE y cargas sociales", "administración + estudio", "semana del 22/09"],
                 ["Corrientes: cerrar la refinanciación en curso con 60 cuotas y gracia", "la dirección", "en curso"],
                 ["Galicia y BBVA: pedir la refinanciación con el número de capacidad de pago", "la dirección", "semana del 28/09"],
                 ["Cargar la caja de AA cada día y el plan de compra de canchada 2027 en la planilla", "administración", "esta semana"],
                 ["Definir con qué se tapa el agujero de septiembre (aporte, activo, adelanto de cobranza, stock)", "Dueños", "antes de octubre"],
                 ["Revisión semanal del cash: disponible, qué se paga, qué se pospone", "administración + finauto", "todos los lunes"]],
