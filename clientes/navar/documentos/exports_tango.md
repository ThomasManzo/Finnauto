...
Cinco consultas, dos empresas (A = NAVAR SA, AA = NAVAR SA Otros). Cada archivo es la foto
...
| 5 | Movimientos de tesorería (solo AA) | Tesorería → Comprobantes | desde 01/06/2026, todos | Tipo · Comprobante · Fecha · Concepto · Clase · **Total (cte)** · Cód. relacionado · **Desc. relacionado** · Fecha de emisión | `AA movimientos tesoreria AAAA-MM-DD.xlsx` | `Tesorería AA` |
